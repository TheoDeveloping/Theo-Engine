...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Searching Play Modes", null);
		#end
		...
		var versionShit:FlxText = new FlxText(10, FlxG.height - 20, 0, "Theo Engine | " + "v." + Application.current.meta.get('version') + " ", 12);
