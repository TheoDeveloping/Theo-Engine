...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		 ...
		 */
		 ...
		 var text:FlxText = new FlxText(textBG.x - 1, textBG.y + 4, FlxG.width, "", 18);
		 text.text = "Press P To Play The Song | Play I To Play Only The Inst | Press V To Play Only The Vocals";
	...
	override function update(elapsed:Float)
	{
		...
		var playVocals = FlxG.keys.justPressed.V;
		var playInst = FlxG.keys.justPressed.I;
