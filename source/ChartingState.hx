...
class ChartingState extends MusicBeatState
{
	...
	function addSongUI():Void
	{
		...
		var UI_stage = new FlxUIInputText(10, 30, 70, _song.stage, 8);
		typingShit = UI_stage;
		...
		var player3DropDown = new FlxUIDropDownMenu(140, 100, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String)
			{
	...
	function addNoteUI():Void
	{
		...
		tab_group_note.add(clearSectionButton);
