...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			//this shit is for portraits in diferents songs
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			default:
				if (PlayState.hasDialog)// playstate.has dialog y has dialog de dialoguebox.hx son cosas diferentes, no son la misma var
				{
					hasDialog = true;
					box.frames = Paths.getSparrowAtlas('speech_bubble_talking');
					box.animation.addByPrefix('normalOpen', 'Speech Bubble Normal Open', 24, true);
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == 'thorns')
		{
			...
			swagDialogue.color = FlxColor.WHITE;
			dropText.color = FlxColor.BLACK;
		} i added with switch to better shit*/
